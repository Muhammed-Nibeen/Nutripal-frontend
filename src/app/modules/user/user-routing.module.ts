...
{path:'userHome',component:UserHomeComponent,canActivate:[userblockGuard]},
...
{path:'showfood',component:ShowfoodComponent,canActivate:[userblockGuard]},
{path:'consult',component:ConsultComponent,canActivate:[userblockGuard]},
{path:'chat/:id',component:ChatComponent},
{path:'aboutus',component:AboutUsComponent},
{path:'profile',component:ProfileComponent,canActivate:[userblockGuard]},
{path:'userprogress',component:UserProgressComponent,canActivate:[userblockGuard]},
{path:'uservideochat/:id',component:VideochatComponent},
{path:'booking',component:BookingComponent,canActivate:[userblockGuard]},
